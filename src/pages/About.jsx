...
const About = () => {
  ...
  return (
    <section id="about">
      <div className="w-full h-max flex flex-col md:flex-row p-6 md:py-10 about-bg">
        ...
        <div className="md:w-1/2 flex flex-col items-center justify-center text-white">
          ...
          <FadeUp>
            <h1 className="mt-3 poppins-semibold text-xl">
              The <span className="text-secondary">Festivities</span> have begun
              !!
            </h1>
          </FadeUp>
